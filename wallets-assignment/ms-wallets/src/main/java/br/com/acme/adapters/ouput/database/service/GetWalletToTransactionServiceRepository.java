...
@Service
@AllArgsConstructor
public class GetWalletToTransactionServiceRepository implements GetWalletToTransactionRepository {

    private final WalletRepository walletRepository;

    @Override
    public WalletEntity walletToTransaction(String walletNumber) {
